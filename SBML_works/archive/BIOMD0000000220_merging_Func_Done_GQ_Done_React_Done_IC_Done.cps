...
<!-- generated with COPASI 4.40 (Build 278) (http://www.copasi.org) at 2023-12-03T14:41:19Z -->
...
<rdf:Description rdf:about="#Reaction_248">
      ...
      <Reaction key="Reaction_124" name="Translation of Bax_mRNA affecting M#" reversible="false" fast="false" addNoise="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_154" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfModifiers>
        ...
        <ListOfConstants>
          <Constant key="Parameter_6726" name="k" value="0.1"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="t_Bax_mRNA is on" fireAtInitialTime="0" persistentTrigger="0">
        <TriggerExpression>
          &lt;CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[p53_arrester],Reference=Concentration> > 10
        </TriggerExpression>
        <ListOfAssignments>
      ...
      <Event key="Event_1" name="t_Bax_mRNA is off" fireAtInitialTime="0" persistentTrigger="0">
        <TriggerExpression>
          &lt;CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[p53_killer],Reference=Concentration> &lt; 10
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Values[t_Bax_mRNA]" targetKey="ModelValue_177">
            <Expression>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[proCaspase]" value="6.0221407599999699e+28" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[Fourteen33_free]" value="9.2876152571935813e+28" type="Species" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[Bad_0_(free)]" value="3.6644425417561781e+22" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[Cyclin_E (free)]" value="1.0242577447423122e+29" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[E2F1]" value="1.1356372380985125e+29" type="Species" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[SIAH1_0]" value="6.0221407599999734e+28" type="Species" simulationType="reactions">
            <InitialExpression>
              &lt;CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[SIAH1_tot],Reference=InitialConcentration>
            </InitialExpression>
          </ModelParameter>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[p53_S46phosphorylated]" value="6.5442001424843477e+26" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[p53_0phosphorylated]" value="2.6778653317491831e+28" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[mitochondrion],Vector=Metabolites[Bad_phosphorylated_Fourteen33_complex]" value="2.7566662628063479e+28" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[AKT_phosphorylated]" value="1.9379851179755865e+28" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[BclXL_Bad_complex]" value="8.5660839188856845e+27" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[DNA_double_strand_break]" value="1.7164185151336708e+19" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[mitochondrion],Vector=Metabolites[AKT_0]" value="4.0841556420243614e+28" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[PI3K_tot]" value="6.0221407599999663e+28" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[PIP2]" value="3.1645506594093419e+28" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[ATM_0]" value="6.0221407440980666e+28" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[mitochondrion],Vector=Metabolites[AKT_tot]" value="6.0221407599999479e+28" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[mitochondrion],Vector=Metabolites[ATM_tot]" value="6.0221407599999505e+28" type="Species" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[BclXL_tot]" value="6.0221407599999593e+28" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[E2F1_tot]" value="1.2044281519999924e+29" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[Fourteen33_tot]" value="1.2044281519999929e+29" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[PIP_tot]" value="6.0221407599999681e+28" type="Species" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Compartments[cell],Vector=Metabolites[SIAH1_tot]" value="6.0221407599999734e+28" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Reactions[Translation of Bax_mRNA affecting M#]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Reactions[Translation of Bax_mRNA affecting M#],ParameterGroup=Parameters,Parameter=k" value="0" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Albeck2008_extrinsic_apoptosis,Vector=Values[t_Bax_mRNA],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="Duration" type="float" value="500000"/>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Caspase &amp; M#" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="x axis" type="string" value=""/>
      <Parameter name="y axis" type="string" value=""/>
    ...
    <PlotSpecification name="p53_killer_related_species" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="x axis" type="string" value=""/>
      <Parameter name="y axis" type="string" value=""/>
